            ...
            <div class="flex ml-auto" v-else>
              <div class="dropdown inline-block relative z-10">
                ...
                <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 shadow w-full -mt-2">
                  <li>
                    <nuxt-link to="/dashboard" class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap">My Dashboard</nuxt-link>
                  </li>
                  <li>
                    <nuxt-link to="/dashboard" class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap">Account Settings</nuxt-link>

                  </li>
                  <li>
                    <a  @click="logout()" to="/dashboard" class="cursor-pointer rounded-b bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap">Logout</a>
